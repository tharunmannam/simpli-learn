...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
  ...
  <!-- end -->
  <link rel="stylesheet" type="text/css" href="coursecontent_css.css">
...
<body>
	...
	<div class="header-left">
      ...
      <div class="header-right"> 
		...
		%>
          <a href="ai.jsp" class="nav" style="background-color: red; border-radius: 10px;">Dashboard</a>
	...
	<div id="contents" class="container1 module">
			<h1 style="font-size:40px;margin-top: 25px;margin-left: 350px;">Artificial Intelligence</h1>
			...
			String sql1 ="SELECT * FROM lect where subject='Artificial Intelligence' ";
	...
	<div id="resources" class="container1 module">
			<button class="uploadbut"><a href="add_resource.jsp" style="color:white";><i class="fa fa-plus" aria-hidden="true"></i>Upload Notes</a></button>
			<%try{
			Connection connection1 = null;
		    connection1 = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system","tharun");
			Statement statement1 = connection1.createStatement();
			String sql1 ="SELECT * FROM resources where subject='Artificial Intelligence' ";
			ResultSet rs1=statement1.executeQuery(sql1);
			while(rs1.next()){
			%>
			<div class="card1">
