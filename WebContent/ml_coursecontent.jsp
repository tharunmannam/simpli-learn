...
<body>
	...
	<div id="contents" class="container1 module">
			<h1 style="font-size:40px;margin-top: 25px;margin-left: 370px;">Machine Learning</h1>
			
			<%try{
			Connection connection1 = null;
		    connection1 = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system","tharun");
			Statement statement1 = connection1.createStatement();
			String sql1 ="SELECT * FROM lect where subject='Machine Learning' ";
	...
	<div id="resources" class="container1 module">
		    ...
		    connection1 = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system","tharun");
			Statement statement1 = connection1.createStatement();
			String sql1 ="SELECT * FROM resources where subject='Machine Learning' ";
			ResultSet rs1=statement1.executeQuery(sql1);
			while(rs1.next()){
			%>
			<div class="card1">
		...
		<div class="col-md-10 discuss" style="margin: auto;border: 3px solid #000;">
            <div class="panel" id="chat">
							...
							<div class="chat" id="mentor">
	                            <div class="chat-avatar">
	                                <a class="avatar avatar-online" data-toggle="tooltip" href="#" data-placement="right"
	                                    ...
	                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjcW5so9-mZEGxar6TmEUqb4YD_Ohy-JdKNA&usqp=CAU" alt="mentor">
	                                    <i></i>
	                                </a>
	                            </div>
				...
				<div class="panel-footer">
                    <form action="./askquestion5" method="POST">
