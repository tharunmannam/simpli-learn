...
<body style="background-color:#f9f9f9;">
	...
	<div class="header-left">
      ...
      <div class="header-right"> 
		...
		%>
          <a href="student.jsp" class="nav1">Dashboard</a>
          <a href="mentors.jsp" class="nav1">Mentors</a>
          <a href="mycourses.jsp" class="nav1">My Courses</a>
          <a href="studentprofile.jsp" class="nav1" style="background-color: red; border-radius: 10px;">Profile</a>
    ...
    try{
		...
		String sql1 ="SELECT * FROM studentsinfo";
		
		ResultSet rs1=statement1.executeQuery(sql1);
		while(rs1.next()){
			if(rs1.getString("email").equals(value)){
   	...
   	<section class="py-5 my-5">
		<div class="container">
				...
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						<div class="img-circle text-center mb-3">
							<img src="https://thumbs.dreamstime.com/z/man-profile-cartoon-smiling-vector-illustration-graphic-design-135443492.jpg" alt="Image" class="shadow">
						</div>
			...
			<div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
					...
					<form action="./studprofile1.jsp" method="post">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
								  	<label>Email</label>
								  	<input type="text" class="form-control" name="email" value="<%=value%>" disabled>
								</div>
							</div>
						</div>
						<div>
					...
					<form action="./studprofile2.jsp" method="post">
