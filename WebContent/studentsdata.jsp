...
<link rel="stylesheet" type="text/css" href="studentsdata_css.css">
		...
		try{
			...
			%>
					<tr>
						...
						<td>
							<span class="btn btn-success"><a href="updatestuddetails_admin.jsp?email=<%=rs.getString("email")%>" style="color:white;">Update</a></span>
						</td>
						<td>
							<span class="button button1"><i class="fa fa-trash"></i><a href="deletestuddetails_admin.jsp?email=<%=rs.getString("email")%>" style="color:white;">Delete</a></span>
						</td>
					</tr>
